...
namespace MadelineParty.Minigame.Display
{
    public class MinigameReadyPrompt : Entity
    {
        ...
        {
            base.Added(scene);
            Add(new MultiplayerHandlerComponent<MinigameReady>("ReadyPrompt", HandleReady));
        ...
        private void HandleReady(MPData data)
        {
            ...
            if (GameData.Instance.celestenetIDs.Contains(ready.ID) && ready.ID != MultiplayerSingleton.Instance.CurrentPlayerID()) {
