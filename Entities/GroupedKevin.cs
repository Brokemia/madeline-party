...
namespace MadelineParty.Entities
{
    ...
    [Tracked]
    public class GroupedKevin : Solid
    {
        public enum Axes
        {
            Both,
        ...
        public Dictionary<GroupedKevin, Vector2> initialOffsets = new Dictionary<GroupedKevin, Vector2>();
        ...
        public GroupedKevin(Vector2 position, float width, float height, Axes axes, bool chillOut = false)
        ...
        public GroupedKevin(EntityData data, Vector2 offset)
        ...
        public override void Awake(Scene scene)
        {
            ...
            foreach (GroupedKevin kevin in scene.Tracker.GetEntities<GroupedKevin>())
            {
                if (kevin != this)
                {
